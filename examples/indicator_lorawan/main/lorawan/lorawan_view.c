...
static void __view_event_handler(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    ...
    switch (event_id) {
        ...
        case VIEW_EVENT_LORAWAN_JOIN_ACTION: // shangdian
            ESP_LOGI(TAG, "event: VIEW_EVENT_LORAWAN_JOIN_ACTION");//asdasd
            ...
            if (startup) {
                ...
                lv_label_set_text(ui_LblLoRaWANStatus, "Join");//asdasd
...
void fn_LoRaWANStatus_clicked(lv_event_t *e)//asdasd
{
